...
## Características
- **Manipulación de objetos**: Escalar, rotar y mover elementos en el lienzo.
- **Soporte para formas**: Añade cuadrador y circulos. (Mas en proximas versiones).
- **Carga de imágenes**: Importa imágenes para editarlas directamente en el lienzo.
...
2. Usa las herramientas disponibles para editar imágenes o crear diseños.
3. Guarda tu trabajo utilizando la opción de exportación.
